    ...
    return (
        <div className="relative group cursor-pointer">
            ...
            <Card className="flex items-end relative bg-white bg-opacity-0 group-hover:bg-opacity-40 min-h-60">
                <div className="grid grid-cols-3 content-end p-2 transition-all duration-300 ease-in-out transform translate-y-1 opacity-0 group-hover:translate-y-0 group-hover:opacity-100">
                    ...
                    <span className="text-balance text-[10px] xs:text-xs text-black col-span-3 py-1 text-justify">{description}</span>
